...
require H2O_ROOT.'h2o-personal-extension/traduzione.php';
require H2O_ROOT.'h2o-personal-extension/generici.php';
...
function h2o($name, $options = array()) {
    ...
    h2o::addFilter('module4');
    function module4($number) {
        return ($number % 4)==0;
    }
?>
